...
inline void SHA1Transform(uint32_t state[5], uint8_t const buffer[64])
{
	uint32_t a, b, c, d, e;
...
inline void SHAPrintContext(SHA_CTX *context, char *msg)
{
...
template <class BlkFun>
inline void internal_update(SHA_CTX* context, uint8_t const* data, uint32_t len)
{
	uint32_t i, j;	// JHB
...
inline void SHA1_Init(SHA_CTX* context)
{
...
inline void SHA1_Update(SHA_CTX* context, uint8_t const* data, uint32_t len)
{
...
inline void SHA1_Final(uint8_t* digest, SHA_CTX* context)
{
